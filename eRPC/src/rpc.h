...
class Rpc {
 ...
 public:
  ...
  inline MsgBuffer alloc_msg_buffer_or_die(size_t max_data_size) {
    ...
    rt_assert(m.buf != nullptr, "Could not allocate msgbuf.\n");
    return m;
  }
  ...
  bool reset_session(int session_num);
 ...
 public:
  ...
  bool retry_connect_on_invalid_rpc_id = true;
 ...
 private:
  ...
  // Rpc metadata
  size_t creator_etid;        ///< eRPC thread Ireset_session resettingD of the creator thread
